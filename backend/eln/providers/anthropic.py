...
class AnthropicProvider(BaseProvider):
    """LangChain-backed Anthropic Claude provider."""

    def __init__(self, model: str | None = None, **kwargs):
        self._model_name = model or settings.default_model or _DEFAULT_MODEL
    ...
    def with_model(self, model: str) -> "AnthropicProvider":
        """Return a new provider instance using a different model."""
    ...
    async def chat(
        ...
        with tracer.start_as_current_span("llm.chat") as span:
            ...
            spec = get_spec("anthropic", self._model_name)
            return LLMResponse(
                text=full_text,
